                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white rounded-lg shadow-lg p-6">
                            <h2 className="text-2xl font-bold text-slate-800 mb-4">Main Content Area</h2>
                            <p className="text-slate-600 mb-4">
                                This is where the main profile content would go. The sidebar on the left shows different states:
                            </p>

                            <div className="space-y-4">
                                <div className="p-4 bg-slate-50 rounded-lg">
                                    <h3 className="font-semibold text-slate-800 mb-2">Complete Profile</h3>
                                    <p className="text-sm text-slate-600">
                                        Shows a user with all fields filled, multiple skills, contact info, and recent job applications.
                                    </p>
                                </div>

                                <div className="p-4 bg-slate-50 rounded-lg">
                                    <h3 className="font-semibold text-slate-800 mb-2">Minimal Profile</h3>
                                    <p className="text-sm text-slate-600">Shows a user with basic information and fewer skills.</p>
                                </div>

                                <div className="p-4 bg-slate-50 rounded-lg">
                                    <h3 className="font-semibold text-slate-800 mb-2">Empty Profile</h3>
                                    <p className="text-sm text-slate-600">
                                        Shows a user with minimal data and empty states for skills and description.
                                    </p>
                                </div>

                                <div className="p-4 bg-slate-50 rounded-lg">
                                    <h3 className="font-semibold text-slate-800 mb-2">No User (Loading)</h3>
                                    <p className="text-sm text-slate-600">Shows the loading state when no user data is available.</p>
                                </div>
                            </div>
                            <div className="mt-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="p-3 border border-slate-200 rounded-lg">
                                        <h4 className="font-medium text-slate-700 mb-1">Profile Avatar</h4>
                                        <p className="text-sm text-slate-600">
                                            Gradient background with user initial and online status indicator
                                        </p>
                                    </div>
                                    <div className="p-3 border border-slate-200 rounded-lg">
                                        <h4 className="font-medium text-slate-700 mb-1">Quick Actions</h4>
                                        <p className="text-sm text-slate-600">Edit and View profile buttons for easy access</p>
                                    </div>
                                    <div className="p-3 border border-slate-200 rounded-lg">
                                        <h4 className="font-medium text-slate-700 mb-1">Skills Management</h4>
                                        <p className="text-sm text-slate-600">Clean skill badges with add functionality</p>
                                    </div>
                                    <div className="p-3 border border-slate-200 rounded-lg">
                                        <h4 className="font-medium text-slate-700 mb-1">Recent Applications</h4>
                                        <p className="text-sm text-slate-600">Interactive job cards with hover effects</p>
                                    </div>
                                    <div className="p-3 border border-slate-200 rounded-lg">
                                        <h4 className="font-medium text-slate-700 mb-1">Contact Information</h4>
                                        <p className="text-sm text-slate-600">Organized contact details with icons</p>
                                    </div>
                                    <div className="p-3 border border-slate-200 rounded-lg">
                                        <h4 className="font-medium text-slate-700 mb-1">Profile Completion</h4>
                                        <p className="text-sm text-slate-600">Progress bar to encourage profile completion</p>
                                    </div>
                                </div>
                            </div>
                        </div>
