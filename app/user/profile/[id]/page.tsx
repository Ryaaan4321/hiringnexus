      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-[#e1e1e1]">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            <span className="inline-flex items-center gap-1.5 px-2.5 sm:px-3 py-1 rounded-full bg-[#dbefdb] text-[#1e3c2c] text-[11px] sm:text-xs font-medium font-mono border border-[#b8dfb8]">
            ...
            <button
              ...
              className="home-btn home-btn-glass text-xs cursor-pointer flex items-center gap-1.5 min-h-[32px]"
            >
              {copied ? (
                <>
