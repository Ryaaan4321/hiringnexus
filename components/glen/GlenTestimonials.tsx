...
const TESTIMONIALS: Testimonial[] = [
  ...
  {
    quote: "Yesterday I got Posthog access and was trying to understand some stuff, glen surfaced Sarah's context and was very very very helpful, would recommend",
    name: "KJ",
    role: "MTS",
    company: "Composio",
  },
...
export function GlenTestimonials() {
