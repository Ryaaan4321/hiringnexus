...
const ITEMS: Item[] = [
  {
    ...
    detail: {
      ...
      body: "Highlight anything in a diff and ask why it is there. Glen queries a clone of the agent that wrote it, so a question about a thirty-second retry backoff comes back with the incident that set it, the Slack thread where it was argued, and the ticket it came from.",
    },
  },
  {
    ...
    detail: {
      ...
      body: "Glen finds the prior work that bears on the task and steers your model with it, so nobody re-establishes background that already exists. You write a two-line prompt instead of pasting the same architecture summary for the fourth time, and equivalent work comes back significantly faster and on fewer tokens.",
    },
  },
  {
    ...
    detail: {
      ...
      body: "An agent with tool access picks whichever app it thinks holds the answer, queries that one, and stops there. The real answer is usually spread across a Slack thread, a ticket, a call, and an old agent session. Glen assembles all of it first, so everyone gets the same complete answer.",
    },
  },
  {
    ...
    detail: {
      ...
      body: "Everyone uploads the skills they already have, and Glen distills new ones out of the work as it happens. They live in the cloud, not on anyone's machine, so nobody sends a skill around or wonders where one went. When someone hits a task a skill covers, Glen surfaces it inside whatever they are running, Claude Code or Codex, without them knowing it existed.",
    },
  },
  {
    ...
    detail: {
      ...
      body: "Glen is not only for coding. The way your strongest people work stops being locked in their heads. A new rep runs call review the way your head of sales does, and someone outside the design team builds a deck that looks like your head of design made it, because the agents learned from their actual work.",
    },
  },
  {
  ...
  },
  {
    ...
    detail: {
      ...
      body: "Glen keeps when decisions were made, who made them, and what led to them: one queryable timeline of the whole organization. Tracing a Q2 outage, you follow the thread back to a January design call, the trade-off noted in March, and who signed off, in minutes instead of weeks.",
    },
  },
  {
    ...
    detail: {
      ...
      body: "Transcripts, skills, and artifacts live with Glen, not inside whichever client each person happens to use. That holds whether your team is split across three clients today or all on one and migrating providers tomorrow. Otherwise the context your company built belongs to whichever vendor you are currently paying.",
    },
  },
];

export function GlenWhyAccordion() {
  ...
  return (
    <div id="why-glen" className="mt-28 scroll-mt-24 md:mt-44">
      <div className="mx-auto w-full max-w-[85rem] px-5 md:px-10">
        <div className="relative flex overflow-hidden rounded-[24px] md:min-h-[760px]">
          {/* Ambient dark gradient background matching TryGlen */}
          <div
        ...
        <div className="mt-5 flex justify-end">
          <a href="https://app.tryglen.com" className="home-arrow-link cursor-pointer">
